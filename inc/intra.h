...
public:
    ...
    bool upper_available;
    bool left_available;
    bool all_available;

    Predictor(int size): upper_available(false), left_available(false), all_available(false) {
      switch (size) {
        case 8:
...
Predictor get_intra8x8_chroma_predictor(const Block8x8&, const Block8x8&, const Block8x8&);
